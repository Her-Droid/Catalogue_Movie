...
import com.freisia.cataloguemoviedb.utils.HelperForExoPlayer
import com.freisia.cataloguemoviedb.utils.PlayerListener
import com.freisia.cataloguemoviedb.utils.Utils
...
class AutoPlayerManager {
    ...
    fun setup() {
        playerView = StyledPlayerView(getContext())
    ...
    private fun StyledPlayerView.getPlayerParent(): AutoPlayer? {
